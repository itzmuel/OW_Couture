...
export default async function WeddingCollectionPage() {
  const collection = await getCatalogCollection("wedding");
  const products = await getCatalogProductsByCollection("Wedding Dresses");

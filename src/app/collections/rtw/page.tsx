...
export default function RTWCollectionPage() {
  const products = getProductsByCollection("RTW Collection");
    ...
    <main>
      <section className="border-b border-[var(--line)] py-20">
        <div className="mx-auto w-full max-w-[1180px] px-4 sm:px-6 lg:px-8">
          ...
          <p className="mb-3 text-xs uppercase tracking-[0.16em] text-[var(--muted)]">RTW Collection</p>
          <h1 className="max-w-4xl text-[clamp(34px,5vw,64px)] leading-[1] tracking-[-0.055em] text-neutral-950">
            Ready-to-wear, made slowly.
          </h1>
          <p className="mt-4 max-w-3xl text-base leading-8 text-[var(--muted)] sm:text-lg">
            Pre-order refined silhouettes or customize measurements before checkout.
          </p>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="mx-auto w-full max-w-[1180px] px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-14 rounded-[28px] border border-[var(--line)] bg-[var(--soft)] p-8">
            <p className="text-xs uppercase tracking-[0.16em] text-[var(--muted)]">Book a Tailoring Consultation</p>

...
export default async function EveningCollectionPage() {
  const collection = await getCatalogCollection("evening");
  const products = await getCatalogProductsByCollection("Bridesmaids & Evening");

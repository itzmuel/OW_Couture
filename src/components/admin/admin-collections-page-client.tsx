          ...
          {draft ? (
            <div className="grid gap-3">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <label className="flex items-center gap-2 pt-6 text-sm text-neutral-800"><input type="checkbox" checked={draft.archived} onChange={(event) => setDraft((current) => current ? { ...current, archived: event.target.checked } : current)} disabled={!hasPermission("collections:archive")} /> Archived</label>
              </div>
